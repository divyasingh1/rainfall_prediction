data<-read.csv("aeon_stock.csv",stringsAsFactors = FALSE)
...
testjan1<-filter(testjan1,SD_Name=="EI_AELKO14")
...
testmay1<-filter(testmay1,SD_Name=="EI_AELKO14")
...
testnov1<-filter(testnov1,SD_Name=="EI_AELKO14")
...
finaltest<-filter(finaltest,SD_Name=="EI_AELKO14")
